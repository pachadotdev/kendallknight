...
tldr; If you have a large dataset, this package implements a different algorithm
from the one implemented in base R, and it reduces the complexity of the
Kendall's correlation coefficient from O(n^2) to O(n log n). This package is
written in C++ and uses cpp11 to export the functions to R. See the vignette
