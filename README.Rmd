...
[![Test coverage](https://raw.githubusercontent.com/pachadotdev/kendallknight/coverage/badges/coverage.svg)](https://github.com/pachadotdev/kendallknight/actions/workflows/test-coverage.yaml)
...
This package implements a different algorithm from the one implemented in
