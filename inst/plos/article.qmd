...
languages multiple times. The following diagram shows the data flow in the
package:

**Fig 1. Workflow diagram showing the data flow in the kendallknight package.**
...
The percentages in Table 2 reveal that base R implementation takes around 50%
...
knitr::kable(
  ...
  caption = "Computation time for the model coefficients and the pseudo-$R^2$ statistic. Source: own creation.",
  align = c("l","r","r"),
