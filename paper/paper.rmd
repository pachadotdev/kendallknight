...
| number of observations | kendallknight median time | base R median time |
|------------------------|---------------------------|--------------------|
| 10,000                 | 0.002 s                   | 1.4 s              |
| 20,000                 | 0.004 s                   | 5.1 s              |
| 30,000                 | 0.005 s                   | 11.8 s             |
| 40,000                 | 0.006 s                   | 20.5 s             |
| 50,000                 | 0.008 s                   | 32.0 s             |
| 60,000                 | 0.009 s                   | 44.4 s             |
| 70,000                 | 0.011 s                   | 60.6 s             |
| 80,000                 | 0.013 s                   | 78.1 s             |
| 90,000                 | 0.013 s                   | 99.7 s             |
| 100,000                | 0.015 s                   | 123.0 s            |

\newpage

| number of observations | kendallknight memory allocation | base R memory allocation |
|------------------------|---------------------------------|--------------------------|
| 10,000                 | 1.45 MB                         | 0.84 MB                  |
| 20,000                 | 2.75 MB                         | 1.45 MB                  |
| 30,000                 | 4.12 MB                         | 2.18 MB                  |
| 40,000                 | 5.49 MB                         | 2.90 MB                  |
| 50,000                 | 6.87 MB                         | 3.62 MB                  |
| 60,000                 | 8.24 MB                         | 4.35 MB                  |
| 70,000                 | 9.61 MB                         | 5.07 MB                  |
| 80,000                 | 11.0 MB                         | 5.80 MB                  |
| 90,000                 | 12.4 MB                         | 6.52 MB                  |
| 100,000                | 13.7 MB                         | 7.25 MB                  |

These results can be complements with the following plots:

```{r plots, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 4.5}
library(ggplot2)
library(bench)
library(dplyr)
library(tintin)
...
```{r plots2, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 4.5}
# plot memory
...
benchmarking tests in a clean R session without other processes running in the
background (e.g., such as automatic updates) on a ThinkPad X1 Carbon with an
Intel Core i7-1185G7 with eight cores running Pop!_OS 22.04.
